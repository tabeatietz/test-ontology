 ...
 * [cto.yml](cto.yml)
     * Determines how your purl.obolibrary.org/obo/cto/ redirects will be handled
     ...
     * Paste in the contents of [cto.yml](cto.yml)
 ...
 * [cto.md](cto.md)
     ...
     * Paste in the contents of [cto.md](cto.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
